...
#define FFMPEG_CONFIGURATION "--prefix=/home/ffmpeg/FFmpeg-Android/android/armv7-a --disable-encoders --disable-decoders --disable-hwaccels --disable-devices --disable-avdevice --disable-ffprobe --disable-programs --disable-postproc --enable-static --disable-doc --disable-symver --disable-ffplay --disable-doc --disable-w32threads --disable-os2threads --disable-stripping --enable-neon --disable-shared --enable-libx264 --enable-gpl --enable-pic --enable-jni --enable-pthreads --enable-mediacodec --enable-ffmpeg --enable-encoder=aac --enable-encoder=gif --enable-encoder=mjpeg --enable-encoder=libx264 --enable-encoder=vorbis --enable-encoder=mpeg4 --enable-encoder=png --enable-encoder=srt --enable-encoder=subrip --enable-encoder=yuv4 --enable-encoder=text --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=ac3 --enable-decoder=pgssub --enable-decoder=opus --enable-decoder=dca --enable-decoder=mp3 --enable-decoder=pcm_s16le --enable-decoder=pcm_s16le_planar --enable-decoder=pcm_s16be --enable-decoder=pcm_s16be_planar --enable-decoder=vorbis --enable-decoder=flac --enable-decoder=flv --enable-decoder=png --enable-decoder=mjpeg --enable-decoder=srt --enable-decoder=xsub --enable-decoder=yuv4 --enable-decoder=vp9 --enable-decoder=vp9_mediacodec --enable-decoder=h264_mediacodec --enable-decoder=h264 --enable-decoder=hevc_mediacodec --enable-decoder=hevc --enable-hwaccel=h264_mediacodec --enable-hwaccel=vp9_mediacodec --enable-cross-compile --cross-prefix=/home/ndk/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=android --arch=arm --sysroot=/home/ndk/android-ndk-r15c/platforms/android-21/arch-arm --extra-cflags='-I/home/ffmpeg/FFmpeg-Android/x264/android/armv7-a/include -fPIE -pie' --extra-ldflags=-L/home/ffmpeg/FFmpeg-Android/x264/android/armv7-a/lib"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/home/ffmpeg/FFmpeg-Android/android/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "/home/ffmpeg/FFmpeg-Android/android/armv7-a/share/ffmpeg"
